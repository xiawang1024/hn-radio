			...
			<View className='player-box'>
				...
				<View className='ctrl-wrap'>
					...
					<View className='btn-wrap'>
						<Image onClick={this.clickPrev} className='icon-prev' src={require('./icon-prev.png')} />
						<View className='icon-play-wrap' onClick={this.playSwitch}>
							<Image
								className='icon-play-pause'
								src={isPlay ? require('./icon-pause.png') : require('./icon-play.png')}
							/>
						</View>
						<Image onClick={this.clickNext} className='icon-next' src={require('./icon-next.png')} />
					</View>
					<View className='list' onClick={this.onOpenList}>
						<Image className='icon-list' src={require('./icon-list.png')} />
					</View>
				</View>
				{isShowInfo ? <PlayInfo onCloseInfo={this.onCloseInfo} playInfo={isPlayInfo} /> : ''}
				{isShowList ? (
					<PlayList onCloseList={this.onCloseList} onSwitchPlay={this.onSwitchPlay} playCid={isPlayInfo.cid} />
				) : (
					''
				)}
			</View>
